...
- `FaceData` (Mới)
- `FaceAuthLogs` (Mới)
- `Amenities` (Thêm cột RequireFaceAuth)
- `AmenityBookings` (Thêm cột CheckInMethod)
- `Residents`
...
*Tài liệu phân công công việc - Nhóm 5 - Cập nhật: 12/02/2026*
